...
description: Jupyter 中 Kernel 介绍。
date: 2025-10-24
...
2. 新建 Notebook 或打开现有 Notebook。
3. 点击右上角的 Kernel 名称（如 “Python 3”），选择你注册的 **“Python 3.13.5 (my project)”**。
4. 此时 Notebook 就运行在你指定的 Python 3.13.5 环境中！
