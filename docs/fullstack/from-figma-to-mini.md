...
+ 生成的设计稿，如图
![stitch design](/assets/fullstack/figma-to-mini/stitch-01.png)
+ 复制到 Figma，如图
![stitch copy to figma](/assets/fullstack/figma-to-mini/stitch-02.png)

## Figma - AI 原型设计精细控制

+ [Figma 官网](https://www.figma.com/)
+ 将 Stitch 生成的设计稿，逐一复制到 Figma 中，放在同一个 Figma 文件中，如图
![figma design](/assets/fullstack/figma-to-mini/figma-01.png)
+ 在 Figma 中，可以做细节上的修改
...
![cursor mcp](/assets/fullstack/figma-to-mini/cursor-add-mcp-01.png)
...
+ 最终还原后的结果如下，可见还原度比较高
![cursor design to code](/assets/fullstack/figma-to-mini/cursor-01.png)

## 在 CodeBuddy 中还原设计稿的代码

### MCP 配置

![CodeBuddy mcp](/assets/fullstack/figma-to-mini/codebuddy-mcp.png)
...
![codebuddy result](/assets/fullstack/figma-to-mini/codebuddy-01.png)
