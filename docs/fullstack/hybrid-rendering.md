...
![hybrid-rendering](/assets/fullstack/hybrid/ssr-csr-ssr.webp)
...
![render-strategies](/assets/fullstack/hybrid/render-strategies.webp)

## CSR - Client Side Rendering（客户端渲染）

客户端渲染（Client-Side Rendering）是在浏览器中使用JavaScript动态生成页面内容的技术。

![csr](/assets/fullstack/hybrid/csr.webp)
...
![ssr](/assets/fullstack/hybrid/ssr.webp)
...
![ssg](/assets/fullstack/hybrid/ssg.webp)
...
![isr](/assets/fullstack/hybrid/isr.webp)
