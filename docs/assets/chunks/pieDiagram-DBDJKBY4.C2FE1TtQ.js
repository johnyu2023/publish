import{p as j}from"./chunk-ANTBXLJU.3U2VEMl-.js";import{W as S,Q as F,aG as q,_ as p,g as H,s as Q,a as Z,b as J,q as K,p as X,l as z,c as Y,D as ee,H as te,a4 as ae,e as re,y as ne,F as ie}from"../app.KKy2H38r.js";import{p as se}from"./treemap-75Q7IDZK.nu7r4eES.js";import{d as I}from"./arc.BFYHH5bL.js";import{o as le}from"./ordinal.BYWQX77i.js";import"./framework.BX-G93LU.js";import"./theme.2GPRGRkH.js";import"./baseUniq.CeJ0BUOu.js";import"./basePickBy.D49SBc_f.js";import"./clone.6AaRFdNU.js";import"./init.Gi6I4Gst.js";function oe(e,a){return a<e?-1:a>e?1:a>=e?0:NaN}function ce(e){return e}function ue(){var e=ce,a=oe,f=null,y=S(0),s=S(F),o=S(0);function l(t){var n,c=(t=q(t)).length,g,x,h=0,u=new Array(c),i=new Array(c),v=+y.apply(this,arguments),w=Math.min(F,Math.max(-F,s.apply(this,arguments)-v)),m,C=Math.min(Math.abs(w)/c,o.apply(this,arguments)),$=C*(w<0?-1:1),d;for(n=0;n<c;++n)(d=i[u[n]=n]=+e(t[n],n,t))>0&&(h+=d);for(a!=null?u.sort(function(A,D){return a(i[A],i[D])}):f!=null&&u.sort(function(A,D){return f(t[A],t[D])}),n=0,x=h?(w-c*$)/h:0;n<c;++n,v=m)g=u[n],d=i[g],m=v+(d>0?d*x:0)+$,i[g]={data:t[g],index:n,value:d,startAngle:v,endAngle:m,padAngle:C};return i}return l.value=function(t){return arguments.length?(e=typeof t=="function"?t:S(+t),l):e},l.sortValues=function(t){return arguments.length?(a=t,f=null,l):a},l.sort=function(t){return arguments.length?(f=t,a=null,l):f},l.startAngle=function(t){return arguments.length?(y=typeof t=="function"?t:S(+t),l):y},l.endAngle=function(t){return arguments.length?(s=typeof t=="function"?t:S(+t),l):s},l.padAngle=function(t){return arguments.length?(o=typeof t=="function"?t:S(+t),l):o},l}var pe=ie.pie,G={sections:new Map,showData:!1},T=G.sections,W=G.showData,ge=structuredClone(pe),de=p(()=>structuredClone(ge),"getConfig"),fe=p(()=>{T=new Map,W=G.showData,ne()},"clear"),me=p(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);T.has(e)||(T.set(e,a),z.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),he=p(()=>T,"getSections"),ve=p(e=>{W=e},"setShowData"),Se=p(()=>W,"getShowData"),L={getConfig:de,clear:fe,setDiagramTitle:X,getDiagramTitle:K,setAccTitle:J,getAccTitle:Z,setAccDescription:Q,getAccDescription:H,addSection:me,getSections:he,setShowData:ve,getShowData:Se},ye=p((e,a)=>{j(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),xe={parse:p(async e=>{const a=await se("pie",e);z.debug(a),ye(a,L)},"parse")},we=p(e=>`
  .pieCircle{
