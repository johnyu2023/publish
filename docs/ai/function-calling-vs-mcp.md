...
![Function Calling](/assets/ai/fuction-calling-vs-mcp/function-calling.png)
...
![Function Calling](/assets/ai/fuction-calling-vs-mcp/function-calling-call-function.png)
...
![MCP](/assets/ai/fuction-calling-vs-mcp/mcp-vs-function-calling-01.gif)
...
![MCP 架构](/assets/ai/fuction-calling-vs-mcp/mcp-architecture.webp)

## 5. MCP 的意义

![MCP 前后对比](/assets/ai/fuction-calling-vs-mcp/mcp-before-after.png)
